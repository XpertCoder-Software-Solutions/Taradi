...
router.post("/:customerId/messages", requirePermission("chats.send_message"), chatController.sendMessage);
router.post("/:customerId/messages/media", requirePermission("chats.send_media"), singleMediaUpload, chatController.sendMediaMessage);
